...
Run it once; it is not on a schedule, unlike scripts/generate_stats.py.
    ...
    python scripts/make_portrait.py photo.png --crop 400,110,910,790
...
COLS = 300                 # below ~88 the face muddies; far above it dominates
...
FONT_SIZE = 12.9
LINE_H = 15
ROW_DELAY = 0.02           # per-row stagger, seconds
